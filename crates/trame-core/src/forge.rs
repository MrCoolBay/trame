...
//! GitHub ; GitLab dit « merge request ». La cible primaire de Trame est GitLab
...
pub trait Forge: Send + Sync {
    ...
    ///
    /// C'est le point d'entree de la boucle de review : chaque thread non resolu
...
pub struct ReviewThread {
    /// Son identifiant.
    pub id: ThreadId,
    /// Le fichier concerne, si le thread est ancre sur du code.
    pub path: Option<String>,
    /// La ligne concernee, si le thread est ancre sur du code.
    pub line: Option<u32>,
