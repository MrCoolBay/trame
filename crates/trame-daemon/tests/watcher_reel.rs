...
// pas de test.
//
// **Le `cfg` porte sur un module et non sur la crate**, et ca aussi a ete appris d'un echec :
// en crate-level, il retire jusqu'a la documentation de module ci-dessus, et `missing_docs`
// echoue sur Linux. Trouve par le premier run de CI du projet.
//
